...
const typeOrmModuleOptions = {
  useFactory: async (
    ...
    entities: [Alarm,Board,CardLabel,JoinMember,Card,CheckItem,CheckList,Comment,Label,List,Member,User],
...
@Module({
  imports: [ ConfigModule.forRoot({
    ...
    UsersModule, BoardsModule, ListsModule, CardsModule, CommentsModule, ChecklistsModule, AlarmsModule, MembersModule, CardMembersModule, LabelsModule, CheckitemsModule, CardLabelsModule],
